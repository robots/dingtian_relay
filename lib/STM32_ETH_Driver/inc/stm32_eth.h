...
// PHY BCR
#define PHY_BCR_DUPLEX              ((uint16_t)0x0100)
#define PHY_BCR_AUTONEG             ((uint16_t)0x1000)
#define PHY_BCR_SPEED               ((uint16_t)0x2000)

// PHY BSR
#define PHY_BSR_LINK                ((uint16_t)0x0004)
#define PHY_BSR_AUTONEG_COMPLETE    ((uint16_t)0x0010)

// PHY interrupts source/mask
#define PHY_INT_ENERGY              ((uint16_t)0x0080)
#define PHY_INT_AUTONEG             ((uint16_t)0x0040)
#define PHY_INT_RFAULT              ((uint16_t)0x0020)
#define PHY_INT_LINK                ((uint16_t)0x0010)

// PHY_SR
#define PHY_SR_AUTONEG_DONE         ((uint16_t)0x1000)
